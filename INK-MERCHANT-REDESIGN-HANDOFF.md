...
- Use one blue highlight family across Orders, Dashboard, Settings, map, rings, and checkmarks. No green anywhere: ink does not judge a delivery, and nothing says one was seen or confirmed at the door (Sam, 2026-09-23: "we dont judge delivery"; 2026-09-24: "we cant confirm at door"). Use Shopify Polaris components and tokens only; no custom CSS, outside chrome, or Ritualist typography.
