...
async function fuzz() {
  ...
  const p = {
    ...
    // Testing all shop identifiers!
    shop: "taimoor1-2.myshopify.com",
    shop_domain: "taimoor1-2.myshopify.com",
    shopDomain: "taimoor1-2.myshopify.com",
    merchant_id: "taimoor1-2.myshopify.com",
    merchantId: "taimoor1-2.myshopify.com",
  ...
  console.log(`With all merchant variants payload -> ${res.status}: ${await res.text()}`);
}
